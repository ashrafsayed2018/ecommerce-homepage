  ...
  return (
    <div className="py-14 px-4 md:px-6">
      <div className="flex justify-start items-start space-y-2 flex-col">
        <h1 className="text-sm lg:text-lg font-bold leading-7 lg:leading-9 text-gray-900">
          رقم الطلب # {orderDetails && orderDetails._id}
        </h1>
      ...
      <div className="mt-10 flex flex-col justify-center xl:flex-row items-stretch w-full xl:space-x-8 md:space-y-6 xl:space-y-0">
        <div className="flex flex-col justify-start items-start w-full space-y-4 md:space-y-6 xl:space-y-8">
          <div className="flex flex-col justify-start items-start bg-gray-50 px-4 py-4 md:p-6 xl:p-8 w-full">
            <p className="font-bol text-lg ">تفاصيل الطلب</p>
            {orderDetails &&
            ...
            <div className="flex flex-col px-4 py-6 md:p-6 xl:p-8 w-full bg-gray-50 space-y-6">
              ...
              <div className="flex justify-center items-center w-full space-y-4 flex-col border-gray-200 border-b pb-4">
                <div className="flex justify-between w-full">
                  <p className="text-base leading-5 text-gray-800">الاجمالي</p>
                  <p className="text-base leading-5 text-gray-900">
                    {" "}
                    د.ك {orderDetails && orderDetails.totalPrice}
                  </p>
                </div>
                <div className="flex justify-between w-full">
        ...
        <div className="flex flex-col gap-5">
          <div className="bg-gray-50 w-full xl:w-96 flex  items-center md:items-start px-4 py-6 flex-col">
            ...
            <div className="flex flex-col justify-start items-start flex-shrink-0">
              <div className="flex gap-4 justify-center flex-col w-full md:justify-start items-start py-8 border-b border-gray-200">
          ...
          <div className="flex justify-between xl:h-full items-stretch w-full flex-col mt-6 md:mt-0">
            <div className="flex justify-center md:justify-start xl:flex-col flex-col md:space-x-6 lg:space-x-8 xl:space-x-0 space-y-4 md:space-y-0 xl:space-y-12 md:flex-row items-center md:items-start ">
              <div className="flex justify-center md:justify-start items-center md:items-start flex-col space-y-4 xl:mt-8">
                ...
                <p>
                  المدينة :{orderDetails && orderDetails.shippingAddress.city}
                </p>
                <p>
                  البلد : {orderDetails && orderDetails.shippingAddress.country}
                </p>
                <p>
                  الرمز البريدي :{" "}
          ...
          <button
            onClick={() => router.push(`/`)}
            className="block w-full mt-5  text-center p-3 rounded-xl my-4 mx-auto bg-blue-700 text-white"
          >
            العودة للرئيسية
          </button>
        </div>
